...
// because 6 = 1 + 2 + 3. Write a method isPerfect that determines whether parameter number
// is a perfect number.Use this method in an application that displays all the perfect numbers
// between 1 and 1000. Display the factors of each perfect number to confirm that the number is
// indeed perfect.Challenge the computing power of your computer by testing numbers much larger
